...
public class L_value {
    ...
    static HashMap<String, PT_L_value> map_list_term;
    static List<Map.Entry<String, PT_L_value>> entries;
    ...
    private static void compute_L_value(){
    ...
    private static void L_value(int i){
        double c_value;
    ...
    private static List sortMap_by_Importance(){
        try{
            ...
            Collections.sort(getEntries(), new Comparator<Map.Entry<String, PT_L_value>>() {
                @Override
                public int compare(Entry<String, PT_L_value> o1, Entry<String, PT_L_value> o2) {
        ...
        for (final Entry<String, PT_L_value> entry : getEntries()) {
    ...
    private static List sortMap_by_Num_Words(){
        ...
        try{
            ...
            Collections.sort(getEntries(), new Comparator<Map.Entry<String, PT_L_value>>() {
                @Override
                public int compare(Map.Entry<String, PT_L_value> o1, Map.Entry<String, PT_L_value> o2) {
    ...
    private static void Add_Term(String term_candidate, String pos, String pos_alternative, int frequency, int num_word, int freq_pattern){
        ...
        if(map_list_term.containsKey(aux_string_term)){
            ...
            PT_L_value ct = new PT_L_value(aux_string_term, pos, pos_alternative, 1, num_word, freq_pattern);
     ...
     */
    private static void setEntries(List<Map.Entry<String, PT_L_value>> aEntries) {
        entries = aEntries;
    }
     ...
     * @return the entries
     */
    private static List<Map.Entry<String, PT_L_value>> getEntries() {
        return entries;
    }
