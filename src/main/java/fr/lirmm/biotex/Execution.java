...
import fr.lirmm.pattern.Pattern;
import fr.lirmm.pattern.PatternProb;
import fr.lirmm.pos.POSTreeTagger;
import fr.lirmm.validation.Validation;
...
public class Execution {
    ...
    static ArrayList<CandidatTerm> list_candidat_terms = new ArrayList<>();
        ...
        */  
            ...
            if(typeSource == 1){//Single file
                if(ParameterVerification.verifySource_is_TextFile(source)==1){//If 1, then is a text file
                    ...
                    al_POS_Phrases = POSTreeTagger.POS_TreeTagger(file_to_tag, language, source_tagger);
