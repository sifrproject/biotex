...
import fr.lirmm.object.PTLValue;
import fr.lirmm.object.Word;
...
public class LValue {
    ...
    static HashMap<String, PTLValue> map_list_term;
    static List<Map.Entry<String, PTLValue>> entries;
    ...
    private static List sortMap_by_Importance(){
        try{
            ...
            Collections.sort(getEntries(), new Comparator<Map.Entry<String, PTLValue>>() {
                @Override
                public int compare(Entry<String, PTLValue> o1, Entry<String, PTLValue> o2) {
        ...
        for (final Entry<String, PTLValue> entry : getEntries()) {
    ...
    private static List sortMap_by_Num_Words(){
        ...
        try{
            ...
            Collections.sort(getEntries(), new Comparator<Map.Entry<String, PTLValue>>() {
                @Override
                public int compare(Map.Entry<String, PTLValue> o1, Map.Entry<String, PTLValue> o2) {
    ...
    private static void Add_Term(String term_candidate, String pos, String pos_alternative, int frequency, int num_word, int freq_pattern){
        ...
        if(map_list_term.containsKey(aux_string_term)){
            ...
            PTLValue ct = new PTLValue(aux_string_term, pos, pos_alternative, 1, num_word, freq_pattern);
     ...
     */
    private static void setEntries(List<Map.Entry<String, PTLValue>> aEntries) {
        entries = aEntries;
    }
     ...
     * @return the entries
     */
    private static List<Map.Entry<String, PTLValue>> getEntries() {
        return entries;
    }
